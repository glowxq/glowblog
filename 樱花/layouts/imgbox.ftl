...
">
	...
	<div class="focusinfo">
		...
		<#elseif settings.focus_tou == "glitch-text">
			...
			<h1 class="center-text glitch glow-text-title" data-text="${settings.glitch_text}">${settings.glitch_text}</h1>
			</#if>
		</#if>
		<div class="header-info">
			<#if user.description?default("")?trim?length gt 1>
				...
				<div style="height:30px;" ><span class="glow-text" data-spotlight="${user.description}">${user.description}</span></div>
			</#if>
