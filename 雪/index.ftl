        ...
        <header class="bg-cover" id="homeHeader">
            ...
            <div class="cover-content flex justify-center">
                ...
                <div class="inner flex flex-col justify-center">
                    <h2  class=" home-title cover-title text-left md:text-4xl lg:text-4xl xl:text-5xl"><span class="glow-text-title" data-spotlight="${options.blog_title!}">${settings.home_title!options.blog_title!}</span></h2>
                    <p class="slogan text-center">${settings.home_description!}</p>
                    <p class="slogan text-center ">
                        <span class="glow-text" data-spotlight="${settings.home_description_glow!}">${settings.home_description_glow!}</span>
                    </p>
